                  ...
                  <div className="lc-menu" style={{ position: 'absolute', top: '0.5rem', right: '0.5rem', zIndex: 10 }}>
                    ...
                    <div className="lc-dropdown" onClick={e => e.stopPropagation()}>
                      ...
                      {listing.status === 'paused' ? (
                        <button className="lc-dropdown-item" onClick={() => { document.querySelectorAll('.lc-dropdown').forEach(d => d.classList.remove('active')); handleUpdateStatus(listing.id, 'active'); }}>
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="5 3 19 12 5 21 5 3"/></svg> Resume
                        </button>
                      ) : (
                        <button className="lc-dropdown-item" onClick={() => { document.querySelectorAll('.lc-dropdown').forEach(d => d.classList.remove('active')); handleUpdateStatus(listing.id, 'paused'); }}>
                      ...
                      {listing.status !== 'sold_out' ? (
                        <button className="lc-dropdown-item" onClick={() => { document.querySelectorAll('.lc-dropdown').forEach(d => d.classList.remove('active')); handleUpdateStatus(listing.id, 'sold_out'); }}>
                      ...
                      <button className="lc-dropdown-item lc-dropdown-item--danger text-danger" onClick={() => { document.querySelectorAll('.lc-dropdown').forEach(d => d.classList.remove('active')); handleDeleteClick(listing); }}>
